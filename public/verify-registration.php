...
if (!isset($_SESSION['reg_user_id'], $_SESSION['reg_email'], $_SESSION['reg_code'])) {
    redirect('/register.php');
}

$user_id = (int)$_SESSION['reg_user_id'];
$email   = $_SESSION['reg_email'];
$shown_code = $_SESSION['reg_code']; // “si email”
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($code === '') {
        ...
        if (verify_code($user_id, $code, 'registration')) {
            ...
            unset($_SESSION['reg_user_id'], $_SESSION['reg_email'], $_SESSION['reg_code']);
            $ok = true;
        } else {
